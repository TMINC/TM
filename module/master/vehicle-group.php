...
?>
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <h3 class="heading">GRUPO(S)-VEH&Iacute;CULO</h3>
            <div class="clearfix sepH_b">
                <div class="btn-group col_vis_menu">
                    ...
                    <ul class="dropdown-menu tableMenu" id="dt_maintenance_nav">
                        ...
                        <li><div class="checkbox"><label class="" for="dt_col_4"><input type="checkbox" value="3" id="dt_col_4" name="toggle-cols" checked="checked" class="uni_style"/> DENOMINACI&Oacute;N</label></div></li>
            ...
            <table class="table table-striped table-bordered dTableR" id="dt_maintenance">
                <thead>
                    <tr>
                        ...
                        <th class="center">DENOMINACI&Oacute;N</th>
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-bordered" >
                        ...
                        <tr>
                            ...
                            <td class="form-group"><input class="form-control" type="text" id="editDesignation" name="editDesignation"></td>
                        </tr>
                        <tr>
                            <td><b>ESTADO :</b></td>
    ...
    <!-- crud functions -->
    <script src="js/controller/crud_vehicle-group.js"></script>
    <script>
