            ...
            <div class="clearfix sepH_b">
                <div class="btn-group col_vis_menu">
                    ...
                    <ul class="dropdown-menu tableMenu" id="dt_maintenance_nav">
                        ...
                        <li><div class="checkbox"><label class="" for="dt_col_3"><input type="checkbox" value="2" id="dt_col_3" name="toggle-cols" checked="checked"/> INFO</label></div></li>
                        <li><div class="checkbox"><label class="" for="dt_col_4"><input type="checkbox" value="3" id="dt_col_4" name="toggle-cols" checked="checked"/> NOMBRE</label></div></li>
                        <li><div class="checkbox"><label class="" for="dt_col_5"><input type="checkbox" value="4" id="dt_col_5" name="toggle-cols" checked="checked"/> DESCRIPCI&Oacute;N</label></div></li>
    ...
    <div class="modal" id="modal">
        <div class="modal-dialog">
            <div class="modal-content">        
                ...
                <tr>
                    <td><b>INFO :</b></td>
                    <td><input class="form-control" type="text" id="editInfo"></td>
                </tr>
                <tr>
                    <td><b>NOMBRE :</b></td>
