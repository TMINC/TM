...
?>
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <h3 class="heading">REGISTRO PROVEEDOR-VEH&Iacute;CULO</h3>
            <div class="clearfix sepH_b">
                <div class="btn-group col_vis_menu">
                    ...
                    <ul class="dropdown-menu tableMenu" id="dt_maintenance_nav">
                        ...
                        <li><div class="checkbox"><label class="" for="dt_col_2"><input type="checkbox" value="1" id="dt_col_2" name="toggle-cols" checked="checked" class="uni_style"/> PROVEEDOR</label></div></li>
    ...
    <!-- crud functions -->
    <script src="js/controller/crud_registration-carrier-vehicle.js"></script>
    <script>
        $(document).ready(function() {
            //* show all elements & remove preloader
            setTimeout('$("html").removeClass("js")',1000);
            $('#collapseOne').addClass(' in');
            $('#info-registration-carrier-vehicle').addClass(' active');
        });
    </script>