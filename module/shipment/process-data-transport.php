            ...
            <div class="modal-content">        
                ...
                <form id="validation_transport">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td><b>PLACA ADICONAL :</b></td>
                            <td class="form-group"><input class="form-control" type="text" id="editAditionalPlate" name="editAditionalPlate"></td>
                        </tr>   
                        <tr>
                            <td><b>IMEI :</b></td>
    ...
    <div class="modal" id="modal_state">
        <div class="modal-dialog">
            <div class="modal-content">        
                <div class="modal-header">
                    <button class="close" data-dismiss="modal">×</button>
                    <h3><i class="glyphicon glyphicon-file" style="margin-top: 3px;font-size:15px;"></i> INFORME</h3>
                </div>
                <div class="modal-body">
