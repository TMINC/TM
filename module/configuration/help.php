...
?>
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <h3 class="heading"><i class="glyphicon icon-truck"></i>AYUDA</h3>
                ...
                <div class="modal-body">
                    <form id="validation_form">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td><b>USUARIO :</b></td>
                                <td class="form-group" colspan="2"><input class="form-control" readonly="true" type="text" id="editUser" name="editUser" value="<?php echo $_SESSION['username'];?>"></td>
                            </tr>
                             <tr>
                                <td><b>FORMULARIO :</b></td>
                                <td class="form-group" colspan="2"><select class="input-xlarge form-control chzn_edit" id="editForm" name="editForm" data-placeholder="SELECCIONE FORMULARIO..." /></td>
                             </tr>
                             </tr>
                             <tr>
                                <td><b>NIVEL DE ATENCI&Oacute;N :</b></td>
                                <td class="form-group" colspan="2"><select class="input-xlarge form-control chzn_edit" id="editLevel" name="editLevel" data-placeholder="SELECCIONE NIVEL ATENCI&Oacute;N..." /></td>
                             </tr>
                            <tr>
                                <td><b>TEXTO :</b></td>
