...
?>
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <h3 class="heading">FORMULARIO(S)</h3>
            <div class="clearfix sepH_b">
                <div class="btn-group col_vis_menu">
                    ...
                    <ul class="dropdown-menu tableMenu" id="dt_maintenance_nav">
                        ...
                        <li><div class="checkbox"><label class="" for="dt_col_4"><input type="checkbox" value="3" id="dt_col_4" name="toggle-cols" checked="checked" class="uni_style"/> C&Oacute;DIGO</label></div></li>
