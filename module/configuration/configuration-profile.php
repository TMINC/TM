...
?>
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <h3 class="heading"><i class="glyphicon icon-truck"></i>MANTENIMIENTO DE PERFIL(ES)</h3>
            <div class="clearfix sepH_b">
                <div class="btn-group col_vis_menu">
                    ...
                    <ul class="dropdown-menu tableMenu" id="dt_maintenance_nav">
                        ...
                        <li><div class="checkbox"><label class="" for="dt_col_2"><input type="checkbox" value="1" id="dt_col_2" name="toggle-cols" checked="checked" class="uni_style"/> ID PERFIL</label></div></li>
                        <li><div class="checkbox"><label class="" for="dt_col_3"><input type="checkbox" value="2" id="dt_col_3" name="toggle-cols" checked="checked" class="uni_style"/> DESCRIPCION</label></div></li>
                        <li><div class="checkbox"><label class="" for="dt_col_4"><input type="checkbox" value="3" id="dt_col_4" name="toggle-cols" checked="checked" class="uni_style"/> ESTADO</label></div></li>
    ...
    <!-- crud functions -->
    <script src="js/controller/crud_configuration-profile.js"></script>
    <!-- lock screen-->    
