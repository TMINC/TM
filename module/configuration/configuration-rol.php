...
?>
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <h3 class="heading"><i class="glyphicon icon-truck"></i>MANTENIMIENTO DE ROL(ES)</h3>
            <div class="clearfix sepH_b">
                <div class="btn-group col_vis_menu">
                    ...
                    <ul class="dropdown-menu tableMenu" id="dt_maintenance_nav">
                        ...
                        <li><div class="checkbox"><label class="" for="dt_col_3"><input type="checkbox" value="2" id="dt_col_3" name="toggle-cols" checked="checked" class="uni_style"/> ID PERFIL</label></div></li>
                        ...
                        <li><div class="checkbox"><label class="" for="dt_col_5"><input type="checkbox" value="4" id="dt_col_5" name="toggle-cols" checked="checked" class="uni_style"/> DESCRIPCION PERFIL</label></div></li>
                        <li><div class="checkbox"><label class="" for="dt_col_6"><input type="checkbox" value="5" id="dt_col_6" name="toggle-cols" checked="checked" class="uni_style"/> ESTADO</label></div></li>
            ...
            <table class="table table-striped table-bordered dTableR" id="dt_maintenance">
                <thead>
                    <tr>
                        ...
                        <th class="center" style="width: 150px;">ID PERFIL</th>
    ...
    <!-- crud functions -->
    <script src="js/controller/crud_configuration-role.js"></script>
    <!-- lock screen-->    
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#configuration-rol').addClass(' active');
        });
    </script>