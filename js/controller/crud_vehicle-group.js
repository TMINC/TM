...
var editar = function(){
    $(".edit").off().on('click', function (e) {
        ...
        var _designation = $(this).data('designation'); $("#editDesignation").val(_designation);
...
var guardar = function () {
    $("#save").off().on('click', function (e) {
        ...
        if($('#validation_form').validate({
            ...
            var _designation = $("#editDesignation").val();
            var _status = $("#editStatus").is(':checked');
            var _action = $("#editAction").val();
            $.ajax({
                type: "POST",
                url: "module/master/crud/vehicle-group.php",
                data: "action="+ _action +"& id="+ _id+"& name="+ _name +"& designation="+ _designation+"& status="+ _status,
                success: function () {
                    load();      
