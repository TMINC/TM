...
;(function($) {
    ...
    var methods = {
        ...
        _createBackButton: function(nav, index) {
            var self       = this,
                that       = $(this),
                attributes = { href: 'JavaScript:void(0);', 'class': 'button-back btn btn-primary', html: self.opt.backLabel };
        ...
        _createNextButton: function(nav, index) {
            var self       = this,
            that       = $(this),
            attributes = { href: 'JavaScript:void(0);', 'class': 'button-next btn btn-primary', html: self.opt.nextLabel };
            $('<a/>', attributes).on('click.stepy', function(e) {
                e.preventDefault();
        ...
        restart: function(callback, index) {
            methods.step.call(self, (index + 1) + 1);
        }, 
